...
function showVehFlowChart(){
    ...
    $.getJSON("vehiclestatjson?fromdate=" + $("#fromdate").val() + "&todate=" + $("#todate").val(),function(data){
...
function drawVehFlowHourStat(){
    ...
    $.getJSON("vehiclehourstatjson?fromdate=" + $("#fromdate").val() + "&todate=" + $("#todate").val(),function(data){
        var clabels = [];
        var cvalues = [];
...
function drawVehTypeStat(){
    ...
    $.ajax({
        type: "POST",
        url: "vehicletypestatjson?fromdate=" + $("#fromdate").val() + "&todate=" + $("#todate").val(),
        dataType: "json",
...
function drawVehBrandStat(){
    ...
    $.ajax({
        type: "POST",
        url: "vehiclebrandstatjson?fromdate=" + $("#fromdate").val() + "&todate=" + $("#todate").val(),
        dataType: "json",
        success: function (data) {
            var etdataset = [];
            var etlabels = [];
