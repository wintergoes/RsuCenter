    ...
    <div class="row">
        ...
        <table class="table mb-0 table-hover table-bordered" >         
                <tbody>
                    ...
                    <tr>
                        <td>图片{{$i+1}}</td>
                        <td><a href="{{$radar_video_root_path}}/radarpictures/{{date("Ymd", strtotime($aidevent->eventtime))}}/aid_{{$aidevent->id}}_{{$i+1}}.jpg" target="_blank"><img style="max-width: 600px;" src="{{$radar_video_root_path}}/radarpictures/{{date("Ymd", strtotime($aidevent->eventtime))}}/aid_{{$aidevent->id}}_{{$i+1}}.jpg" /></a></td>
                    </tr>
                    @endfor
                </tbody>
        </table>    
